...
5. In your reply, distinguish clearly between retrieved data and newly added data.
```
...
- [Sources](/collections/sources) — Set up syncs from web, Notion and Google Sheets
