...
└── skill.json     # Optional tool metadata/config
```
...
Describe available tools and endpoints:
...
- Repo: [github.com/scoutos/scout-skills](https://github.com/scoutos/scout-skills)
