...
## Building Delegating Agents

### Configure Delegation in Agent Settings

1. Open your agent in Scout Studio
2. Navigate to **Settings → Delegation**
3. Add agents that this agent can delegate to
4. Configure how delegation is triggered
