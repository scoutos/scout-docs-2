...
Navigate to your agent and click the **Settings** tab.

### Step 2: Find the Schedule Section

Look for the **Schedule** section where you can configure when and how often your agent runs.

### Step 3: Choose Your Schedule Type
...
**Instructions:**
```
Research our top 5 competitors and identify:
- Any pricing changes
...
If your agent calls APIs with rate limits, account for this in your schedule. Running every 5 minutes might exceed limits; every hour is usually safer.
