...
**Long-Term Memory** - Agents can write important information to Drive for later recall. Unlike session memory, files in Drive persist across conversations and agent restarts.
